...
func (_m *InventoryService) GetPart(ctx context.Context, uuid string) (*inventory.Part, error) {
...
//   - ctx context.Context
//   - uuid string
func (_e *InventoryService_Expecter) GetPart(ctx, uuid interface{}) *InventoryService_GetPart_Call {
...
func (_c *InventoryService_GetPart_Call) Return(_a0 *inventory.Part, _a1 error) *InventoryService_GetPart_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *InventoryService_GetPart_Call) RunAndReturn(run func(context.Context, string) (*inventory.Part, error)) *InventoryService_GetPart_Call {
	_c.Call.Return(run)
	return _c
}

// ListParts provides a mock function with given fields: ctx, filter
func (_m *InventoryService) ListParts(ctx context.Context, filter *inventory.PartsFilter) ([]*inventory.Part, error) {
...
func (_c *InventoryService_ListParts_Call) Run(run func(ctx context.Context, filter *inventory.PartsFilter)) *InventoryService_ListParts_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *InventoryService_ListParts_Call) Return(_a0 []*inventory.Part, _a1 error) *InventoryService_ListParts_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *InventoryService_ListParts_Call) RunAndReturn(run func(context.Context, *inventory.PartsFilter) ([]*inventory.Part, error)) *InventoryService_ListParts_Call {
	_c.Call.Return(run)
	return _c
}

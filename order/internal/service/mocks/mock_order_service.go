...
//   - ctx context.Context
//   - uuid string
func (_e *OrderService_Expecter) CancelOrder(ctx, uuid interface{}) *OrderService_CancelOrder_Call {
...
func (_c *OrderService_CreateOrder_Call) Return(orderUUID string, totalPrice float64, err error) *OrderService_CreateOrder_Call {
	_c.Call.Return(orderUUID, totalPrice, err)
	return _c
}
...
//   - ctx context.Context
//   - orderUUID string
func (_e *OrderService_Expecter) GetOrder(ctx, orderUUID interface{}) *OrderService_GetOrder_Call {
...
//   - orderUUID string
func (_e *OrderService_Expecter) PayOrder(ctx, paymentMethod, orderUUID interface{}) *OrderService_PayOrder_Call {
